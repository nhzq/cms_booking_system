...
class NewsPostController extends Controller
{
    ...
    {
        return view('admin.webadmin.news.index')
    ...
    {
        return view('admin.webadmin.news.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('webadmin.news.index');
    }
    ...
    {
        return view('admin.webadmin.news.edit')->with('news', Newspost::find($id));
    }
    ...
    public function trashed()
    {
        ...
        return view('admin.webadmin.news.trashed')
            ->with('i')
