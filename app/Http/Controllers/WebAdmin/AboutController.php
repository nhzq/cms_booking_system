...
class AboutController extends Controller
{
    ...
    {
        return view('admin.webadmin.about.index')->with('about', About::all());
    }
    ...
    {
        return view('admin.webadmin.about.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.webadmin.about.edit')->with('about', $about);
    }
