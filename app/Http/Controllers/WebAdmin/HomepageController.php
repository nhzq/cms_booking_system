...
class HomepageController extends Controller
{
    ...
    {
        return view('admin.webadmin.homepage.index')->with('homepage', Homepage::all());
    ...
    public function edit($id)
    {
        ...
        return view('admin.webadmin.homepage.edit')->with('homepage', $homepage);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('webadmin.homepage.index');
    }
